...
public class CalendarAdapter extends ArrayAdapter<Date> {
    ...
    public View getView(int position, View view, ViewGroup parent)
    {
        ...
        else if (date.getDate() == today.getDate()+2)
        {
            // if it is today, set it to blue/bold
            ((TextView) view).setTypeface(null, Typeface.BOLD);
            ((TextView) view).setTextColor(getContext().getResources().getColor(R.color.green));
        }
        else if (date.getDate() == today.getDate()-2)
        {
            // if it is today, set it to blue/bold
            ((TextView) view).setTypeface(null, Typeface.BOLD);
            ((TextView) view).setTextColor(getContext().getResources().getColor(R.color.red));
        }
        else if (date.getDate() == today.getDate()+5)
        {
            // if it is today, set it to blue/bold
            ((TextView) view).setTypeface(null, Typeface.BOLD);
            ((TextView) view).setTextColor(getContext().getResources().getColor(R.color.zentri_orange));
        }
        else if (date.getDate() == today.getDate()-5)
        {
            // if it is today, set it to blue/bold
            ((TextView) view).setTypeface(null, Typeface.BOLD);
            ((TextView) view).setTextColor(getContext().getResources().getColor(R.color.link_blue));
        }
